---
id: self-attention
title: Self-Attention — Code
group: attention
kind: code
related_concept: /concepts/self-attention
source_files:
  - src/singleheadselfattention.py
---

# Self-Attention — Code

A single-head scaled dot-product self-attention module. Every step is a labelled block: Q/K/V projections, Q·Kᵀ scores, scale by √d, softmax over keys, attention @ V, and the output projection. Heavy inline comments walk the shapes.
