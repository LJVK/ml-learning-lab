...
title: Positional Information — Code
group: attention
kind: code
...
# Positional Information — Code

Two positional-encoding strategies: the classic sinusoidal encoding from Vaswani et al. (deterministic, extrapolates past training length) and learned absolute encodings à la BERT/GPT (simpler, capped at max_len).
